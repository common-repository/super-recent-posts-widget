...
class Super_Recent_Posts_Widget extends WP_Widget {
	...
	protected static $ver = '0.2.3'; //for cache busting
	...
	public function update( $new_instance, $old_instance ) {
		$instance                 = array();
		$instance['term_slug'] = null;
		$instance['taxonomy'] = null;
		if(array_key_exists('taxonomy', $new_instance)) {
			$instance['taxonomy']    = esc_attr( $new_instance['taxonomy'] );
		}
		if(array_key_exists('term_slug', $new_instance)) {
	...
	public function form( $instance ) {
		...
		<div class="srpw-form">
			...
			<div>
				<small>Order and orderby are not required, if blank will default to the default
					<a href="http://codex.wordpress.org/Class_Reference/WP_Query#Order_.26_Orderby_Parameters" target="_BLANK">see here</a> for details
				</small>
			</div>
			</p>
			<?php $this_id = $this->id; ?>
